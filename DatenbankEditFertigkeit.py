...
class Ui_talentDialog(object):
    def setupUi(self, talentDialog):
        ...
        self.gridLayout.addWidget(self.textEdit, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelVoraussetzungen, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.voraussetzungenEdit, 5, 2, 1, 1)
