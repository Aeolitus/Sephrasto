...
class Ui_talentDialog(object):
    def setupUi(self, talentDialog):
        ...
        self.comboSeite = QtWidgets.QComboBox(talentDialog)
        self.comboSeite.setObjectName("comboSeite")
        self.horizontalLayout_3.addWidget(self.comboSeite)
        self.spinSeite = QtWidgets.QSpinBox(talentDialog)
        self.spinSeite.setMaximum(999)
        self.spinSeite.setObjectName("spinSeite")
    ...
    def retranslateUi(self, talentDialog):
        ...
        self.label_8.setText(_translate("talentDialog", "Seitenreferenz"))
