...
class DatenbankEditFertigkeitWrapper(object):
    def __init__(self, datenbank, fertigkeit=None, ueber=False, readonly=False):
        ...
        if ret == QtWidgets.QDialog.Accepted:
            ...
            if ueber:
                ...
                self.fertigkeit.kampffertigkeit = (
                    self.ui.comboKampffertigkeit.currentIndex()
                )
    ...
    def nameChanged(self):
        ...
        if name == "":
            ...
            (self.fertigkeitUeber and name in self.datenbank.übernatürlicheFertigkeiten)
            or (not self.fertigkeitUeber and name in self.datenbank.fertigkeiten)
        ):
