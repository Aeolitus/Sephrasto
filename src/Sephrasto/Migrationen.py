...
class Migrationen():
    ...
    def hausregeln6zu7(root):
        ...
        querverweise = {
            ...
            "Bändiger der Kreaturen" : "Regel:Beschwörungen|Regel:Beschwörungen - Zusätzliche Fähigkeiten",
            "Meister der Seelenlosen" : "Regel:Beschwörungen|Regel:Beschwörungen - Bindung",
            "Blutmagie" : "Abgeleiteter Wert:WS|Regel:Beschwörungen",
            "Gebieter der Finsternis" : "Regel:Beschwörungen|Regel:Beschwörungen - Bindung",
