...
build_exe_options = {
    ...
    "excludes" : ["tkinter", "distutils", "html", "unittest", "pydoc", "bz2", "pyexpat", "lzma", "email", "xml", "socket", "_hashlib", "http", "test", "asyncio", "queue", "select", "xmlrpc", "PySide6.QtSvg", "PySide6.QtVirtualKeyboard", "PySide6.QtWebSockets", "PySide6.QtWebEngineQuick"],
    "optimize" : 2,
