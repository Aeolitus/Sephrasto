...
The libraries are codesigned, but not notarized, so you may need to codesign
them to build your software, and notarize as part of releasing your software.
...
***IMPORTANT The DLL libcpdf.so must be renamed libcpdf.dylib for .NET to be
able to find it.***
...
Files should be named libjcpdf.dylib and libcpdf.so. Put libjcpdf.dylib in
java.library.path. You can put libcpdf.so in the same folder
