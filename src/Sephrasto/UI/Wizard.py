...
class Ui_formMain(object):
    ...
    def retranslateUi(self, formMain):
        ...
        self.label.setProperty("class", _translate("formMain", "smallText"))
        ...
        self.label_2.setProperty("class", _translate("formMain", "panel"))
        self.lblGeschlecht.setText(_translate("formMain", "Geschlecht"))
        self.lblGeschlecht.setProperty("class", _translate("formMain", "h4"))
        self.lblRegeln.setText(_translate("formMain", "Baukasten"))
        self.lblRegeln.setProperty("class", _translate("formMain", "h4"))
        self.lblProfession.setText(_translate("formMain", "Profession"))
        self.lblProfession.setProperty("class", _translate("formMain", "h4"))
        self.lblProfessionKategorie.setText(_translate("formMain", "Professionskategorie"))
        self.lblProfessionKategorie.setProperty("class", _translate("formMain", "h4"))
        ...
        self.lblSpezies.setProperty("class", _translate("formMain", "h4"))
        self.lblKultur.setText(_translate("formMain", "Kultur"))
        self.lblKultur.setProperty("class", _translate("formMain", "h4"))
