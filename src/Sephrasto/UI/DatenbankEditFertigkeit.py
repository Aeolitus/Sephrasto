...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 420, 502))
        ...
        self.gridLayout.addWidget(self.labelVoraussetzungen, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboKampffertigkeit, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboTyp, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelKampffertigkeit, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.tabWidget, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.teVoraussetzungen, 8, 2, 1, 1)
