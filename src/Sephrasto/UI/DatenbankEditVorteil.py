...
class Ui_dialog(object):
    def setupUi(self, dialog):
        ...
        sizePolicy.setHeightForWidth(self.listVerweise.sizePolicy().hasHeightForWidth())
        self.listVerweise.setSizePolicy(sizePolicy)
        ...
        self.gridLayout.addWidget(self.groupBox, 14, 1, 1, 1)
