...
class Ui_talentDialog(object):
    def setupUi(self, talentDialog):
        ...
        talentDialog.setTabOrder(self.comboNachkauf, self.comboTyp)
        talentDialog.setTabOrder(self.comboTyp, self.voraussetzungenEdit)
    ...
    def retranslateUi(self, talentDialog):
        ...
        self.warning.setText(_translate("talentDialog", "<html><head/><body><p>Dies ist ein Ilaris-Standardvorteil. Sobald du hier etwas veränderst, bekommst du eine persönliche Kopie und das Original wird in den Hausregeln gelöscht. Damit erhältst du für diesen Vorteil keine automatischen Updates mehr mit neuen Sephrasto-Versionen.</p></body></html>"))
