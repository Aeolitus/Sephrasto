...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 429, 418))
        ...
        self.labelKategorie.setFont(font1)
        ...
        self.buttonAdd.setMaximumSize(QSize(25, 20))
        ...
        QWidget.setTabOrder(self.spinFW, self.buttonAdd)
        QWidget.setTabOrder(self.buttonAdd, self.plainText)
    ...
    def retranslateUi(self, Form):
        ...
        self.buttonAdd.setProperty("class", QCoreApplication.translate("Form", u"icon", None))
    # retranslateUi
