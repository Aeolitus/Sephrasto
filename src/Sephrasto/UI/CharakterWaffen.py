...
class Ui_formWaffen(object):
    def setupUi(self, formWaffen):
        ...
        self.labelW2 = QLabel(formWaffen)
        self.labelW2.setObjectName(u"labelW2")
        self.labelW2.setMinimumSize(QSize(0, 30))
        self.labelW2.setMargin(0)
        self.labelW2.setIndent(14)

        self.Waffen.addWidget(self.labelW2, 8, 0, 1, 12)

        self.labelW7 = QLabel(formWaffen)
        self.labelW7.setObjectName(u"labelW7")
        self.labelW7.setMinimumSize(QSize(0, 30))
        self.labelW7.setMargin(0)
        self.labelW7.setIndent(14)

        self.Waffen.addWidget(self.labelW7, 28, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW6TopFrame, 22, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW8RightFrame, 31, 11, 1, 1)
        ...
        self.Waffen.addWidget(self.labelW2RightFrame, 7, 11, 1, 1)
        ...
        self.labelW6 = QLabel(formWaffen)
        self.labelW6.setObjectName(u"labelW6")
        self.labelW6.setMinimumSize(QSize(0, 30))
        self.labelW6.setMargin(0)
        self.labelW6.setIndent(14)

        self.Waffen.addWidget(self.labelW6, 24, 0, 1, 12)
        ...
        self.labelW1 = QLabel(formWaffen)
        self.labelW1.setObjectName(u"labelW1")
        self.labelW1.setMinimumSize(QSize(0, 30))
        self.labelW1.setMargin(0)
        self.labelW1.setIndent(14)

        self.Waffen.addWidget(self.labelW1, 4, 0, 1, 12)
        ...
        self.Waffen.addLayout(self.verticalLayout_8, 27, 9, 1, 1)
        ...
        self.labelW4 = QLabel(formWaffen)
        self.labelW4.setObjectName(u"labelW4")
        self.labelW4.setMinimumSize(QSize(0, 30))
        self.labelW4.setMargin(0)
        self.labelW4.setIndent(14)

        self.Waffen.addWidget(self.labelW4, 16, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW3RightFrame, 11, 11, 1, 1)
        ...
        self.Waffen.addWidget(self.labelW1TopFrame, 2, 0, 1, 12)

        self.labelW5 = QLabel(formWaffen)
        self.labelW5.setObjectName(u"labelW5")
        self.labelW5.setMinimumSize(QSize(0, 30))
        self.labelW5.setMargin(0)
        self.labelW5.setIndent(14)

        self.Waffen.addWidget(self.labelW5, 20, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW7RightFrame, 27, 11, 1, 1)
        ...
        self.Waffen.addWidget(self.labelW4RightFrame, 15, 11, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_4, 11, 9, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_6, 19, 9, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_5, 15, 9, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_7, 23, 9, 1, 1)
        ...
        self.Waffen.addWidget(self.labelW7TopFrame, 26, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW5TopFrame, 18, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW5RightFrame, 19, 11, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_2, 3, 9, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_3, 7, 9, 1, 1)
        ...
        self.Waffen.addWidget(self.labelW8TopFrame, 30, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW4TopFrame, 14, 0, 1, 12)
        ...
        self.labelW8 = QLabel(formWaffen)
        self.labelW8.setObjectName(u"labelW8")
        self.labelW8.setMinimumSize(QSize(0, 30))
        self.labelW8.setMargin(0)
        self.labelW8.setIndent(14)

        self.Waffen.addWidget(self.labelW8, 32, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW3TopFrame, 10, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW2TopFrame, 6, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW1RightFrame, 3, 11, 1, 1)
        ...
        self.labelW3 = QLabel(formWaffen)
        self.labelW3.setObjectName(u"labelW3")
        self.labelW3.setMinimumSize(QSize(0, 30))
        self.labelW3.setMargin(0)
        self.labelW3.setIndent(14)

        self.Waffen.addWidget(self.labelW3, 12, 0, 1, 12)
        ...
        self.Waffen.addWidget(self.labelW6RightFrame, 23, 11, 1, 1)
        ...
        self.Waffen.addLayout(self.verticalLayout_9, 31, 9, 1, 1)
        ...
        QWidget.setTabOrder(self.editW1eig, self.comboStil1)
        QWidget.setTabOrder(self.comboStil1, self.addW1)
        ...
        QWidget.setTabOrder(self.editW2eig, self.comboStil2)
        QWidget.setTabOrder(self.comboStil2, self.addW2)
        ...
        QWidget.setTabOrder(self.editW3eig, self.comboStil3)
        QWidget.setTabOrder(self.comboStil3, self.addW3)
        ...
        QWidget.setTabOrder(self.editW4eig, self.comboStil4)
        QWidget.setTabOrder(self.comboStil4, self.addW4)
        ...
        QWidget.setTabOrder(self.editW5eig, self.comboStil5)
        QWidget.setTabOrder(self.comboStil5, self.addW5)
        ...
        QWidget.setTabOrder(self.editW6eig, self.comboStil6)
        QWidget.setTabOrder(self.comboStil6, self.addW6)
        ...
        QWidget.setTabOrder(self.editW7eig, self.comboStil7)
        QWidget.setTabOrder(self.comboStil7, self.addW7)
        ...
        QWidget.setTabOrder(self.editW8eig, self.comboStil8)
        QWidget.setTabOrder(self.comboStil8, self.addW8)
    ...
    def retranslateUi(self, formWaffen):
        ...
        self.labelW2.setText(QCoreApplication.translate("formWaffen", u"-", None))
        self.labelW7.setText(QCoreApplication.translate("formWaffen", u"-", None))
        ...
        self.labelW6.setText(QCoreApplication.translate("formWaffen", u"-", None))
        self.labelW1.setText(QCoreApplication.translate("formWaffen", u"AT* 10 VT* 10 TP 2W6+2", None))
        ...
        self.labelW4.setText(QCoreApplication.translate("formWaffen", u"-", None))
        ...
        self.labelW5.setText(QCoreApplication.translate("formWaffen", u"-", None))
        ...
        self.labelW8.setText(QCoreApplication.translate("formWaffen", u"-", None))
        ...
        self.labelW3.setText(QCoreApplication.translate("formWaffen", u"-", None))
