...
class Ui_formBeschreibung(object):
    ...
    def retranslateUi(self, formBeschreibung):
        ...
        self.tabWidget.setProperty("class", _translate("formBeschreibung", "h2"))
        self.label_10.setText(_translate("formBeschreibung", "Familie/Hintergrund/Herkunft"))
        self.label_10.setProperty("class", _translate("formBeschreibung", "h4"))
        ...
        self.label_5.setProperty("class", _translate("formBeschreibung", "h4"))
        self.label_9.setText(_translate("formBeschreibung", "Aussehen"))
        self.label_9.setProperty("class", _translate("formBeschreibung", "h4"))
        ...
        self.label_11.setProperty("class", _translate("formBeschreibung", "h4"))
        ...
        self.label_8.setProperty("class", _translate("formBeschreibung", "h4"))
