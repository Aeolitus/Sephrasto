...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.showManoever, self.showEinstellung)
        Form.setTabOrder(self.showEinstellung, self.showDeleted)
    ...
    def retranslateUi(self, Form):
        ...
        self.labelParameter.setProperty("class", _translate("Form", "h4"))
        self.checkFilterTyp.setText(_translate("Form", "Filter nach Typ:"))
        self.checkFilterTyp.setProperty("class", _translate("Form", "h4"))
        ...
        self.labelParameter1.setProperty("class", _translate("Form", "h4"))
