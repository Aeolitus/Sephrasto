...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 340, 395))
    ...
    def retranslateUi(self, Form):
        ...
        self.labelVorteil.setProperty("class", _translate("Form", "h4"))
        ...
        self.labelTyp.setProperty("class", _translate("Form", "italic"))
