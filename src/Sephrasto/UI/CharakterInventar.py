...
class Ui_formInventar(object):
    def setupUi(self, formInventar):
        ...
        self.spinR2brust.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2brust.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1bauch.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1bauch.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2kopf.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2kopf.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2RS.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2RS.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2be.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2be.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2rarm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2rarm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3bein.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3bein.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1be.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1be.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1rarm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1rarm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1brust.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1brust.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3rarm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3rarm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1RS.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1RS.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3larm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3larm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2punkte.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2punkte.setReadOnly(True)
        self.spinR2punkte.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.spinR1punkte.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1punkte.setReadOnly(True)
        self.spinR1punkte.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.spinR3kopf.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3kopf.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2bein.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2bein.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3RS.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3RS.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1larm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1larm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3punkte.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3punkte.setReadOnly(True)
        self.spinR3punkte.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
        ...
        self.spinR2bauch.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2bauch.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR2larm.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR2larm.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1kopf.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1kopf.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.labelPunkte.setFont(font1)
        ...
        self.spinR3be.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3be.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3brust.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3brust.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR1bein.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR1bein.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
        ...
        self.spinR3bauch.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.spinR3bauch.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.PlusMinus)
    ...
    def retranslateUi(self, formInventar):
        ...
        self.removeR3.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
        ...
        self.labelRS.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.labelRName.setText(QCoreApplication.translate("formInventar", u"Name", None))
        self.labelRName.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.addR3.setText(QCoreApplication.translate("formInventar", u"+", None))
        self.addR3.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
        self.labelBrust.setText(QCoreApplication.translate("formInventar", u"Brust", None))
        self.labelBrust.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
#if QT_CONFIG(tooltip)
        ...
        self.labelBE.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.labelBauch.setText(QCoreApplication.translate("formInventar", u"Bauch", None))
        self.labelBauch.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.labelRarm.setText(QCoreApplication.translate("formInventar", u"R. Arm", None))
        self.labelRarm.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.labelBein.setText(QCoreApplication.translate("formInventar", u"Bein", None))
        self.labelBein.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.labelLarm.setText(QCoreApplication.translate("formInventar", u"L. Arm", None))
        self.labelLarm.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
#if QT_CONFIG(tooltip)
        ...
        self.labelKopf.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        self.addR1.setText(QCoreApplication.translate("formInventar", u"+", None))
        self.addR1.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
#if QT_CONFIG(tooltip)
        ...
        self.removeR2.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
        self.addR2.setText(QCoreApplication.translate("formInventar", u"+", None))
        self.addR2.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
        self.removeR1.setText(QCoreApplication.translate("formInventar", u"-", None))
        self.removeR1.setProperty(u"class", QCoreApplication.translate("formInventar", u"iconSmall", None))
        self.labelPunkte.setText(QCoreApplication.translate("formInventar", u"Punkte", None))
        self.labelPunkte.setProperty(u"class", QCoreApplication.translate("formInventar", u"h4", None))
        ...
        self.gbInventar.setProperty(u"class", QCoreApplication.translate("formInventar", u"h3", None))
