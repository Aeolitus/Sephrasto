...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 547, 767))
        ...
        self.gridLayout_3.addWidget(self.checkCheatsheet, 6, 0, 1, 3)
        ...
        self.comboFontSize.addItem("")
        self.comboFontSize.addItem("")
        self.gridLayout_3.addWidget(self.comboFontSize, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboBogen, 3, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.comboRegelbasis, 1, 2, 1, 1)
        self.checkWizard = QtWidgets.QCheckBox(self.groupBox)
        self.checkWizard.setChecked(True)
        self.checkWizard.setObjectName("checkWizard")
        self.gridLayout_3.addWidget(self.checkWizard, 0, 0, 1, 1)
        ...
        self.gbPlugins = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.gbPlugins.setObjectName("gbPlugins")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.gbPlugins)
        ...
        self.resetFontOS.setMaximumSize(QtCore.QSize(28, 28))
        self.resetFontOS.setObjectName("resetFontOS")
        self.horizontalLayout_2.addWidget(self.resetFontOS)
        self.resetFontDefault = QtWidgets.QPushButton(self.groupBox_4)
        self.resetFontDefault.setMinimumSize(QtCore.QSize(28, 28))
        self.resetFontDefault.setMaximumSize(QtCore.QSize(28, 28))
        self.resetFontDefault.setObjectName("resetFontDefault")
        ...
        SettingsWindow.setTabOrder(self.resetPlugins, self.comboFont)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.checkWizard.setText(_translate("SettingsWindow", "Charakter Assistent nutzen"))
        ...
        self.resetPlugins.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.buttonPlugins.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.buttonChar.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.resetChar.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.resetRegeln.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.buttonRegeln.setProperty("class", _translate("SettingsWindow", "icon"))
        ...
        self.resetFontDefault.setToolTip(_translate("SettingsWindow", "Darstellungsoptionen auf Sephrastostandard zurücksetzen"))
        self.resetFontDefault.setText(_translate("SettingsWindow", "Zurücksetzen"))
        self.resetFontDefault.setProperty("class", _translate("SettingsWindow", "icon"))
