...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        QWidget.setTabOrder(self.teNotiz, self.checkReq)
        QWidget.setTabOrder(self.checkReq, self.checkFinanzen)
        QWidget.setTabOrder(self.checkFinanzen, self.checkUeberPDF)
        QWidget.setTabOrder(self.checkUeberPDF, self.comboHausregeln)
        QWidget.setTabOrder(self.comboHausregeln, self.comboCharsheet)
        QWidget.setTabOrder(self.comboCharsheet, self.checkRegeln)
        QWidget.setTabOrder(self.checkRegeln, self.comboRegelnGroesse)
    ...
    def retranslateUi(self, Form):
        ...
        self.checkReq.setToolTip(QCoreApplication.translate("Form", u"Falls abgew\u00e4hlt, werden s\u00e4mtliche Voraussetzungspr\u00fcfungen f\u00fcr Vorteile, \u00fcbernat\u00fcrliche Fertigkeiten usw. deaktiviert.", None))
#endif // QT_CONFIG(tooltip)
        self.checkReq.setText(QCoreApplication.translate("Form", u"Voraussetzungen \u00fcberpr\u00fcfen", None))
...
#endif // QT_CONFIG(tooltip)
        self.checkUeberPDF.setText(QCoreApplication.translate("Form", u"PDF-Ausgabe von \u00fcbernat\u00fcrlichen Fertigkeiten manuell ausw\u00e4hlen", None))
...
#endif // QT_CONFIG(tooltip)
        self.checkFinanzen.setText(QCoreApplication.translate("Form", u"Finanzen anzeigen und aktuelle Schicksalspunkte ausgeben", None))
        ...
        self.checkRegeln.setText(QCoreApplication.translate("Form", u"Dem Charakterbogen relevante Ilaris Regeln anh\u00e4ngen", None))
