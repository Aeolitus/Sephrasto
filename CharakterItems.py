...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.lineEdit_12, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_13, 8, 1, 1, 1)
        self.lineEdit_14 = QtWidgets.QLineEdit(Form)
        self.lineEdit_14.setObjectName("lineEdit_14")
        self.gridLayout.addWidget(self.lineEdit_14, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_17, 10, 1, 1, 1)
        self.lineEdit_18 = QtWidgets.QLineEdit(Form)
        self.lineEdit_18.setObjectName("lineEdit_18")
        self.gridLayout.addWidget(self.lineEdit_18, 10, 2, 1, 1)
        self.lineEdit_19 = QtWidgets.QLineEdit(Form)
        self.lineEdit_19.setObjectName("lineEdit_19")
        self.gridLayout.addWidget(self.lineEdit_19, 11, 1, 1, 1)
        self.lineEdit_20 = QtWidgets.QLineEdit(Form)
        self.lineEdit_20.setObjectName("lineEdit_20")
        self.gridLayout.addWidget(self.lineEdit_20, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_22, 12, 2, 1, 1)
        self.lineEdit_23 = QtWidgets.QLineEdit(Form)
        self.lineEdit_23.setObjectName("lineEdit_23")
        self.gridLayout.addWidget(self.lineEdit_23, 13, 1, 1, 1)
        self.lineEdit_24 = QtWidgets.QLineEdit(Form)
        self.lineEdit_24.setObjectName("lineEdit_24")
        self.gridLayout.addWidget(self.lineEdit_24, 13, 2, 1, 1)
        self.lineEdit_25 = QtWidgets.QLineEdit(Form)
        self.lineEdit_25.setObjectName("lineEdit_25")
        self.gridLayout.addWidget(self.lineEdit_25, 14, 1, 1, 1)
        self.lineEdit_26 = QtWidgets.QLineEdit(Form)
        self.lineEdit_26.setObjectName("lineEdit_26")
        self.gridLayout.addWidget(self.lineEdit_26, 14, 2, 1, 1)
