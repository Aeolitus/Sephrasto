...
|addTalent|-|name : str, kosten : int, vorausgesetzteÜbernatürlicheFertigkeit : str, kommentar : str|Fügt dem Charakter das Talent "name" zu regulären Kosten hinzu. Wenn das Script in einem Vorteil verwendet wird, wird der Vorteil dem neuen Talent, als Voraussetzung hinzugefügt. Sobald der Vorteil also abgewählt wird, verliert der Charakter auch das Talent. Wenn der Charakter das Talent bereits besitzt, werden Kosten, Voraussetzungen und Kommentar angepasst, falls gesetzt. Mit dem "kosten"-Parameter können die EP-Kosten geändert werden (optional); bei -1 werden sie nicht verändert. Optional kann außerdem "vorausgesetzteÜbernatürlicheFertigkeit" mit angegeben werden; diese wird dann auch als Voraussetzung hinzugefügt; falls der Charakter sie nicht besitzt, macht das Script nichts. Mit dem "kommentar"-Parameter kann ein Kommentar hinzugefügt werden, falls das Talent dies unterstützt (optional).|
