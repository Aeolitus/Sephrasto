...
|datenbank_laden|Action|{ "datenbank" : Datenbank, "isCharakterEditor" : bool }|Aktion durchführen, bevor die Datenbank geladen wird. Eine Referenz auf das Datenbank-Objekt erhalten.|
