...
Stelle sicher, dass alle Pakete aus der requirements.txt installiert sind. Aktuell nutzen wir außerdem Python 3.9.7 und cx_Freeze 6.15.3 zum Erstellen von Windows builds. Nun solltest du build.bat im Sephrasto root ausführen können.
