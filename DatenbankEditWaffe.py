...
class Ui_talentDialog(object):
    def setupUi(self, talentDialog):
        ...
        talentDialog.setTabOrder(self.spinRW1, self.spinRW2)
        talentDialog.setTabOrder(self.spinRW2, self.spinWMLZ)
    ...
    def retranslateUi(self, talentDialog):
        ...
        self.comboFert.setItemText(6, _translate("talentDialog", "Andere"))
