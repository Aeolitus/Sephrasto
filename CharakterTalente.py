...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 223, 241))
        ...
        self.gridLayout_2.addWidget(self.labelInfo, 3, 0, 1, 1)
        ...
        self.spinKosten.setMaximum(100)
        self.spinKosten.setSingleStep(20)
        self.spinKosten.setObjectName("spinKosten")
        self.gridLayout_2.addWidget(self.spinKosten, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelName, 0, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.plainText, 4, 0, 1, 3)
