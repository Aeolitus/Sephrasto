...
class FertigkeitItemDelegate(QtWidgets.QItemDelegate):
    ...
    def paint(self, painter, option, index):
        if index.row() in self.rowIndicesWithLinePaint:
            ...
            painter.drawLine(
                option.rect.bottomLeft() + QtCore.QPoint(0, 1),
                option.rect.bottomRight() + QtCore.QPoint(0, 1),
            )
    ...
    def load(self):
        ...
        temp = [
            ...
            if Wolke.Char.voraussetzungenPrüfen(
                Wolke.DB.fertigkeiten[el].voraussetzungen
            )
        ]
        if temp != self.availableFerts:
            ...
            self.availableFerts.sort(
                key=lambda x: (Wolke.DB.fertigkeiten[x].printclass, x)
            )

            rowIndicesWithLinePaint = []
            count = 0
            if len(self.availableFerts) > 0:
                lastPrintclass = Wolke.DB.fertigkeiten[
            ...
            for el in self.availableFerts:
                ...
                if el not in Wolke.Char.fertigkeiten:
                    Wolke.Char.fertigkeiten.update(
                        {el: Wolke.DB.fertigkeiten[el].__deepcopy__()}
                    )
                    Wolke.Char.fertigkeiten[el].wert = 0
                Wolke.Char.fertigkeiten[el].aktualisieren()
                tableWidget = QtWidgets.QTableWidgetItem(
                ...
                self.spinRef[Wolke.Char.fertigkeiten[el].name].setFocusPolicy(
                    QtCore.Qt.StrongFocus
                )
                self.spinRef[Wolke.Char.fertigkeiten[el].name].installEventFilter(
                    self.mwp
                )
                self.spinRef[Wolke.Char.fertigkeiten[el].name].setMinimum(0)
                self.spinRef[Wolke.Char.fertigkeiten[el].name].setMaximum(
                    Wolke.Char.fertigkeiten[el].maxWert
                )
                self.spinRef[Wolke.Char.fertigkeiten[el].name].setValue(
                    Wolke.Char.fertigkeiten[el].wert
                )
                self.spinRef[Wolke.Char.fertigkeiten[el].name].setAlignment(
                    QtCore.Qt.AlignCenter
                )
                self.spinRef[Wolke.Char.fertigkeiten[el].name].valueChanged.connect(
                    lambda state, name=Wolke.Char.fertigkeiten[
                        el
                    ].name: self.spinnerClicked(name)
                )
                self.uiFert.tableWidget.setCellWidget(
                    count, 1, self.spinRef[Wolke.Char.fertigkeiten[el].name]
                )
                ...
                self.labelRef[Wolke.Char.fertigkeiten[el].name].setText(
                    str(len(Wolke.Char.fertigkeiten[el].gekaufteTalente))
                )
                self.labelRef[Wolke.Char.fertigkeiten[el].name].setAlignment(
                    QtCore.Qt.AlignCenter
                )
                # self.labelRef.update({Wolke.Char.fertigkeiten[el].name: lab})
                self.layoutRef[Wolke.Char.fertigkeiten[el].name].addWidget(
                    self.labelRef[Wolke.Char.fertigkeiten[el].name]
                )
                self.buttonRef[
                    Wolke.Char.fertigkeiten[el].name
                ] = QtWidgets.QPushButton()
                self.buttonRef[Wolke.Char.fertigkeiten[el].name].setText("+")
                self.buttonRef[Wolke.Char.fertigkeiten[el].name].setMaximumSize(
                    QtCore.QSize(25, 20)
                )
                self.buttonRef[Wolke.Char.fertigkeiten[el].name].clicked.connect(
                    lambda state, name=Wolke.Char.fertigkeiten[
                        el
                    ].name: self.addClicked(name)
                )
                self.layoutRef[Wolke.Char.fertigkeiten[el].name].addWidget(
                    self.buttonRef[Wolke.Char.fertigkeiten[el].name]
                )
                self.widgetRef[Wolke.Char.fertigkeiten[el].name] = QtWidgets.QWidget()
                self.widgetRef[Wolke.Char.fertigkeiten[el].name].setLayout(
                    self.layoutRef[Wolke.Char.fertigkeiten[el].name]
                )
                self.uiFert.tableWidget.setCellWidget(
                    count, 2, self.widgetRef[Wolke.Char.fertigkeiten[el].name]
                )
    ...
    def tableClicked(self):
        if not self.currentlyLoading:
            tmp = self.uiFert.tableWidget.item(
                self.uiFert.tableWidget.currentRow(), 0
            ).text()
        ...
        if not self.currentlyLoading:
            if self.currentFertName != "":
                ...
                self.uiFert.spinPW.setValue(
                    Wolke.Char.fertigkeiten[self.currentFertName].probenwert
                )
                self.uiFert.spinPWT.setValue(
                    Wolke.Char.fertigkeiten[self.currentFertName].probenwertTalent
                )
                self.modified.emit()
    ...
    def updateTalentRow(self):
        for i in range(self.uiFert.tableWidget.rowCount()):
            ...
            self.labelRef[fert].setText(
                str(len(Wolke.Char.fertigkeiten[fert].gekaufteTalente))
            )
